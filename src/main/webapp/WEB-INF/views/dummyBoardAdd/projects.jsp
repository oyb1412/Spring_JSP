...
<form action="${pageContext.request.contextPath}/projects-board-add" method="post">
    ...
    <div id="container">
        <div id="boardAdmin">
            ...
            <label for="memID">소개글</label>
            <input type="text" id="introduce" name="introduce" placeholder="소개글" maxlength="50">

            <label for="memID">걸린기간</label>
            <input type="text" id="indate" name="indate" placeholder="걸린기간" maxlength="20">

            <label for="title">제목</label>
            <input type="text" id="title" name="title" placeholder="제목" maxlength="30">

             <label for="thumbnail">썸네일</label>
              <textarea id="thumbnail" name="thumbnail" placeholder="내용을 입력하세요"
