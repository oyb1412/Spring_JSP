...
<link rel="stylesheet" href="${pageContext.request.contextPath}/css/noticeModify/style.css">
...
<form action="${pageContext.request.contextPath}/notice-modify" method="post">
  <div id="container">
    <div id="boardAdmin">
      <h2 id="boardAdminH2">공지사항 수정</h2>

      <input type="hidden" id="idx" name="idx" value="${notice.idx}" readonly>
      ...
      <textarea id="content" name="content" rows="5" maxlength="1000">${notice.content}</textarea>
